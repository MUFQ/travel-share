...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/python315270dv/examusers/login" ,
            "/python315270dv/examusers/register",
            '/python315270dv/defaultuser/login',
            '/python315270dv/users/login',
        ...
        post_list = [
            '/python315270dv/defaultuser/register',
            '/python315270dv/defaultuser/login',
            '/python315270dv/users/register',
            '/python315270dv/users/login',
            "/python315270dv/examusers/login" ,
            "/python315270dv/examusers/register"
        ]  # 免认证list
