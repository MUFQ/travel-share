...
@main_bp.route("/python315270dv/cal/<tableName>/<columnName>", methods=['GET'])
def python315270dv_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/python315270dv/file/download", methods=['GET'])
def python315270dv_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/python315270dv/file/upload", methods=['POST'])
def python315270dv_file_upload():
    '''
    '''
...
@main_bp.route("/python315270dv/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def python315270dv_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python315270dv/follow/<tableName>/<columnName>", methods=['GET'])
def python315270dv_follow(tableName, columnName):
    '''
...
@main_bp.route("/python315270dv/location", methods=['GET'])
def python315270dv_location():
    '''
...
@main_bp.route("/python315270dv/matchFace", methods=['GET'])
def python315270dv_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/python315270dv/option/<tableName>/<columnName>", methods=['GET'])
def python315270dv_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python315270dv/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def python315270dv_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python315270dv/sh/<tableName>", methods=['POST'])
def python315270dv_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("python315270dv_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/python315270dv/upload/<fileName>", methods=['GET'])
def python315270dv_upload(fileName):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/python315270dv/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/python315270dv/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
